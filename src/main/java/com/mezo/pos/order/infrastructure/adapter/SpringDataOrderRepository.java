...
public interface SpringDataOrderRepository extends JpaRepository<Order, UUID> {
    ...
    java.util.Optional<Order> findFirstByTableIdAndStatusAndDeletedFalse(UUID tableId, OrderStatus status);

    java.util.Optional<Order> findFirstByTableIdAndStatusInAndDeletedFalse(UUID tableId, java.util.List<OrderStatus> statuses);

    List<Order> findByTableIdAndStatusInAndDeletedFalse(UUID tableId, java.util.List<OrderStatus> statuses);
}
