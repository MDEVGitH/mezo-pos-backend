...
public interface OrderRepository {
    ...
    Optional<Order> findFirstByTableIdAndStatus(UUID tableId, OrderStatus status);

    Optional<Order> findFirstByTableIdAndStatusIn(UUID tableId, List<OrderStatus> statuses);
